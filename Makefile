FLAGS=-Wall -Wextra -Wpedantic -std=c++17 -O3 -Wfatal-errors  -Wsign-compare -Wshadow -Wwrite-strings -Wpointer-arith -Winit-self -Wconversion -Wno-sign-conversion -march=native $(CXXFLAGS)
